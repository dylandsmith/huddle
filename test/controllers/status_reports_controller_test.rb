...
class StatusReportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create status_report" do
    assert_difference('StatusReport.count') do
      post status_reports_url, params: { status_report: { project_id: @status_report.project_id, status_date: @status_report.status_date, today: @status_report.today, user_id: @status_report.user_id, yesterday: @status_report.yesterday } }
    end
  ...
  test "should update status_report" do
    patch status_report_url(@status_report), params: { status_report: { project_id: @status_report.project_id, status_date: @status_report.status_date, today: @status_report.today, user_id: @status_report.user_id, yesterday: @status_report.yesterday } }
