...
ActiveRecord::Schema.define(version: 20170912191725) do
  ...
  create_table "projects_users", id: false, force: :cascade do |t|
    t.integer "projects_users_id"
    t.integer "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["projects_users_id"], name: "index_projects_users_on_projects_users_id"
